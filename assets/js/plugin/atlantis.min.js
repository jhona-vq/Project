...
function layoutsColors() {
    ...
    $("body").is("[data-image]") ? $("body").css("background-image", 'url("' + $("body").attr("data-image") + '")') : $("body").css("background-image", "")
}
...
$(document).ready(function() {
    $(".btn-refresh-card").on("click", function() {
        ...
        a.length && (a.addClass("is-loading"),
        setTimeout(function() {
    ...
    if (!c) {
        (C = $(".sidenav-toggler")).on("click", function() {
            1 == h ? ($("html").removeClass("nav_open"),
            C.removeClass("toggled"),
            h = 0) : ($("html").addClass("nav_open"),
            C.addClass("toggled"),
            h = 1)
        }),
        c = !0
    ...
    if (!m) {
        ...
        C.on("click", function() {
            1 == h ? ($("html").removeClass("quick_sidebar_open"),
        ...
        $(".wrapper").mouseup(function(a) {
            var e = $(".quick-sidebar");
            a.target.className == e.attr("class") || e.has(a.target).length || ($("html").removeClass("quick_sidebar_open"),
    ...
    if (!g) {
        ...
        $(".wrapper").hasClass("sidebar_minimize") && (v = 1,
        k.addClass("toggled"),
        k.html('<i class="icon-options-vertical"></i>')),
        k.on("click", function() {
            1 == v ? ($(".wrapper").removeClass("sidebar_minimize"),
            k.removeClass("toggled"),
            k.html('<i class="icon-menu"></i>'),
            v = 0) : ($(".wrapper").addClass("sidebar_minimize"),
            k.addClass("toggled"),
            k.html('<i class="icon-options-vertical"></i>'),
            v = 1),
            $(window).resize()
    ...
    if (!p) {
        ...
        _.on("click", function() {
            1 == f ? ($("html").removeClass("pagesidebar_open"),
            _.removeClass("toggled"),
            f = 0) : ($("html").addClass("pagesidebar_open"),
            _.addClass("toggled"),
            f = 1)
        });
    ...
    $(".wrapper").hasClass("is-show") && (b = 1,
    y.addClass("toggled"),
    y.html('<i class="icon-options-vertical"></i>')),
    y.on("click", function() {
        1 == b ? ($(".wrapper").removeClass("is-show"),
        y.removeClass("toggled"),
        y.html('<i class="icon-menu"></i>'),
        b = 0) : ($(".wrapper").addClass("is-show"),
        y.addClass("toggled"),
        y.html('<i class="icon-options-vertical"></i>'),
        b = 1),
        $(window).resize()
