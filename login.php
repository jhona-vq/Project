...
");
    ...
    if ($result->num_rows === 1) {
        ...
        if (password_verify($password, $row['password'])) {
          ...
          $_SESSION['success'] = "Welcome back, ".$row['full_name']."!";
...
.sidebar-wrapper {
  ...
  <title>Login - Job Order Personnel Management Information System (JOPMIS)</title>
...
<!-- FORGOT PASSWORD -->
  <div class="text-end mb-2">
    <a href="forgot-password.php" style="font-size:13px; color:#6b7280;">
      Forgot Password?
    </a>
  </div>
